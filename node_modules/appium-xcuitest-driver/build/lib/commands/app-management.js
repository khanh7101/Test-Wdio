...
async function mobileKillApp(bundleId) {
    return await (0, utils_1.requireRealDevice)(this, 'Killing app').terminateApp(bundleId, String(this.opts.platformVersion));
}
/**
...
async function mobileListApps(applicationType = 'User') {
    const service = await appium_ios_device_1.services.startInstallationProxyService((0, utils_1.requireRealDevice)(this, 'Listing apps').udid);
    try {
