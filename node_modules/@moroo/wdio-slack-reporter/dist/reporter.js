  ...
  constructor(options) {
    ...
    if (options.slackOptions.type === "web-api") {
      ...
      this._webhookClient = new SlackWebhookClient({
        ...
        icon_url: !options.slackOptions.icon_url && !options.slackOptions.icon_emoji ? SLACK_ICON_URL : void 0,
  ...
  async postMessage(payload) {
    if (this._webClient) {
      try {
        ...
        process.emit(EVENTS.RESULT, { result, error: void 0 });
        return result;
      } catch (error) {
        logger.error(error);
        process.emit(EVENTS.RESULT, { result: void 0, error });
        throw error;
      } finally {
        this._pendingSlackRequestCount--;
      }
